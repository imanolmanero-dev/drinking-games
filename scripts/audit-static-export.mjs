...
export function validateStaticExportAudit(audit, projectRoot = process.cwd()) {
  ...
  if (englishContract.length !== 9 || new Set(englishPathnames).size !== 9 || englishPathnames.some((path) => !/^\/en(?:\/|$)/.test(path))) {
    violations.push("El contrato inglés no contiene exactamente 9 rutas /en únicas.");
  }
